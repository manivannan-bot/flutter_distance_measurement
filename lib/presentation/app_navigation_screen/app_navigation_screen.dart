...
class AppNavigationScreen extends StatelessWidget {
  ...
  onTapSurge(BuildContext context) {
    Navigator.pushNamed(context, AppRoutes.surgeScreen);
  }
  ...
  onTapFareEdit(BuildContext context) {
    Navigator.pushNamed(context, AppRoutes.fareEditScreen);
  }

  onTapFareSettings(BuildContext context) {
  ...
  onTapComplaint(BuildContext context) {
    Navigator.pushNamed(context, AppRoutes.complaintScreen);
  }

  onTapComplaintsList(BuildContext context) {
    Navigator.pushNamed(context, AppRoutes.complaintsListScreen);
  }

  onTapFareCalculation(BuildContext context) {
