...
const String liveServerBaseUrl = 'http://localhost:5050/';

const String versionName = '1.1.4'; //TODO: NEED TO CHANGE BEFORE BUILD
...
class ApiEndPoint {
  static String loginEndPoint = 'api/Teacher/auth/login';
  ...
  static String leaveDetailsEndPoint =
      'api/Teacher/Teacher_controller/get_leave_by_id?id=';
